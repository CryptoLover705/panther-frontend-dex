...
const config: MenuEntry[] = [
  ...
  // },
  {
    ...
    items: [
      {
        label: 'DexGuru',
        href: 'https://dex.guru/token/0x6c015277b0f9b8c24b20bd8bbbd29fdb25738a69-bsc',
      },
      {
        label: 'PooCoin',
        href: 'https://poocoin.app/tokens/0x6c015277b0f9b8c24b20bd8bbbd29fdb25738a69',
      },
      {
        label: 'BoggedFinance',
        href: 'https://charts.bogged.finance/?token=0x6c015277b0f9b8c24b20bd8bbbd29fdb25738a69',
      },
      // {
      //   label: 'DexTools',
  ...
  // },
  {
    ...
    items: [
      ...
      {
        label: 'Github',
        href: 'https://github.com/CryptoLover705',
      },
      // {
      //   label: 'Docs',
